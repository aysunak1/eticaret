    ...
    <ProfilePart></ProfilePart>
      ...
      <div class="col-span-9 grid md:grid-cols-3 gap-4 mt-6 lg:mt-1">
        ...
        <div class="shadow-xl bg-gray-100 px-4 pt-6 ">
            ...
            <div class="space-y-1 mb-5">
                <h3 class="text-gray-600 font-semibold  text-base">ileri web programlama</h3>
                <p class="text-sm text-gray-600">ileriweb@info</p>
                <p class="text-sm text-gray-600">(+90) 555 555 55 55</p>
